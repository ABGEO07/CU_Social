<div id="activity_<?php echo $D->codepost?>" class="oneactivity">
	<div class="oaheader">
        ...
        <div class="info">
            ...
            <div class="idate"><abbr class="timeago" title="<?php echo (date('Y-m-d',$D->a_date).'T'.date('H:i:s',$D->a_date).($C->TimeAgoWithZ==TRUE?'Z':'')); ?>"><?php echo date($this->lang('global_format_date'),$D->a_date);?></abbr></div>
        ...
        <?php if (!empty($D->typepost)) {
				...
				if ($D->typepost=='music') {
					...
					if(substr($D->valueattach, 0, 3) == 'sc:') {
						...
						$cadattach .= '<div style="padding:0px 10px 10px 0px;"><div><img src="'.$C->SITE_URL.'themes/'.$C->THEME.'/imgs/icomusic.png"></div><div style="font-size:13px; color:#999">'.$this->lang('global_post_txt_ilistened').'</div><div style="font-size:16px; font-weight:bold">'.$D->valueattach.'</div></div>';
				...
				if ($D->typepost=='visited') {
					...
					$cadattach .= '<div style="padding:0 10px 20px 0;"><div><img src="'.$C->SITE_URL.'themes/'.$C->THEME.'/imgs/icovisited.png"></div><div style="font-size:13px; color:#999">'.$this->lang('global_post_txt_ivisited').'</div><div style="font-size:16px; font-weight:bold">'.$D->valueattach.'</div></div>';				
				...
				if ($D->typepost=='food') {
					...
					$cadattach .= '<div style="padding:0 10px 20px 0;"><div><img src="'.$C->SITE_URL.'themes/'.$C->THEME.'/imgs/icofood.png"></div><div style="font-size:13px; color:#999">'.$this->lang('global_post_txt_iateat').'</div><div style="font-size:16px; font-weight:bold">'.$D->valueattach.'</div></div>';				
				...
				if ($D->typepost=='movie') {
					...
					$cadattach .= '<div style="padding:0 10px 20px 0;"><div><img src="'.$C->SITE_URL.'themes/'.$C->THEME.'/imgs/icomovie.png"></div><div style="font-size:13px; color:#999">'.$this->lang('global_post_txt_iwatched').'</div><div style="font-size:16px; font-weight:bold">'.$D->valueattach.'</div></div>';				
				...
				if ($D->typepost=='book') {
					...
					$cadattach .= '<div style="padding:0 10px 20px 0;"><div><img src="'.$C->SITE_URL.'themes/'.$C->THEME.'/imgs/icobook.png"></div><div style="font-size:13px; color:#999">'.$this->lang('global_post_txt_iread').'</div><div style="font-size:16px; font-weight:bold">'.$D->valueattach.'</div></div>';				
				...
				if ($D->typepost=='game') {
					...
					$cadattach .= '<div style="padding:0 10px 20px 0;"><div><img src="'.$C->SITE_URL.'themes/'.$C->THEME.'/imgs/icogame.png"></div><div style="font-size:13px; color:#999">'.$this->lang('global_post_txt_iplayed').'</div><div style="font-size:16px; font-weight:bold">'.$D->valueattach.'</div></div>';				
