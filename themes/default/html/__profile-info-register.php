<div class="oneactivity">
	<div class="oabody">
    	...
    	<div class="space04 mrg10T mrg10B"><?php echo $this->lang('global_txt_joined', array('#SITE_TITLE#'=>$C->SITE_TITLE))?> <?php echo date($this->lang('global_format_date'),$D->u->registerdate)?></div>
    </div>
</div>