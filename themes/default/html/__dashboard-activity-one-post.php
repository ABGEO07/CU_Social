        ...
        <?php if (!empty($D->typepost)) {
				...
				if ($D->typepost=='music') {
					...
					if(substr($D->valueattach, 0, 3) == 'sc:') {
						...
						$cadattach .= '<div style="padding:0px 0px 10px;"><div><img src="'.$C->SITE_URL.'themes/'.$C->THEME.'/imgs/icomusic.png"></div><div style="font-size:13px; color:#999">'.$this->lang('global_post_txt_ilistened').'</div><div style="font-size:16px; font-weight:bold">'.$D->valueattach.'</div></div>';
