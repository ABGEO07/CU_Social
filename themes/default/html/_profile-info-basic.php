    	...
    	<table width="100%" border="0" class="table-data">
            ...
            <tr>
                <td class="space-data pdn10R">
                	<div class="info-profile"><a href="<?php echo $C->SITE_URL.$D->u->username?>"><span class="basic-number"><?php echo $D->u->num_posts; ?></span><br/><span class="basic-text"><?php echo ($D->u->num_posts==1?$this->lang('profile_infobasic_photo'):$this->lang('profile_infobasic_photos'))?></span></a></div>
                </td>
