...
<div id="generalspace">
    ...
    <div id="container">
		...
		?>            
        	...
        	<div id="profile2"> 
                <div class="title mrg20T"><?php echo $this->lang('profile_photos_title'); ?></div>
                ...
                <div id="_areanoitem" class="centered txtsize01 mrg20T"><?php echo $this->lang('profile_photos_txtnophotos');?></div>
