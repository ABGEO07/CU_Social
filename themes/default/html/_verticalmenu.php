    ...
    <div>
    	<div class="menuglobal">
            ...
            <div class="menuoption <?php echo($D->optionactive==1?'act':'inact')?>">
                <div class="icopc"><span title="<?php echo $this->lang('profile_vmenu_opc_activity');?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/icomenuactivity20.png"></span></div>
        ...
        <div class="menuglobal">
            ...
            <div class="menuoption <?php echo($D->optionactive==2?'act':'inact')?>">
                <div class="icopc"><span title="<?php echo $this->lang('profile_vmenu_opc_photos');?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/icomyphotos.png"></span></div>
        ...
        <div class="menuglobal">
            ...
            <div class="menuoption <?php echo($D->optionactive==6?'act':'inact')?>">
                <div class="icopc"><span title="<?php echo $this->lang('profile_vmenu_opc_videos');?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/icomyvideos.png"></span></div>
                <div class="txtopc"><?php echo $this->lang('profile_vmenu_opc_videos');?></div>
                <div class="sh"></div>
            </div>
            </a>
        </div>
        ...
        <div class="menuglobal">
            ...
            <div class="menuoption <?php echo($D->optionactive==3?'act':'inact')?>">
                <div class="icopc"><span title="<?php echo $this->lang('profile_vmenu_opc_favorites');?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/icomenufavorites20.png"></span></div>
        ...
        <div class="menuglobal">
            ...
            <div class="menuoption <?php echo($D->optionactive==5?'act':'inact')?>">
                <div class="icopc"><span title="<?php echo $this->lang('profile_vmenu_opc_messages');?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/icomessages.png"></span></div>
        ...
        <div class="menuglobal">
            ...
            <div class="menuoption <?php echo($D->optionactive==4?'act':'inact')?>">
                <div class="icopc"><span title="<?php echo $this->lang('profile_vmenu_opc_userinformation');?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/icomenuinfo20.png"></span></div>
