<?php
	...
	(
		...
		'admin_general_txt_site_description' => 'Описание сайта (SEO):',
		'admin_general_txt_site_keywords' => 'Ключевые слова (SEO):',
		'admin_general_txt_protected' => 'Защищенное соединение (HTTPS):',
		'admin_general_txt_protected_opc01' => 'Да, использовать HTTPS',
		'admin_general_txt_protected_opc02' => 'Нет, только HTTP',
		'admin_general_txt_languages' => 'Показывать список языков:',
		'admin_general_txt_languages_opc01' => 'Показывать',
		'admin_general_txt_languages_opc02' => 'Скрывать',
		'admin_general_txt_pages' => 'Показывать ссылки на статичные страницы:',
		'admin_general_txt_pages_opc01' => 'Показывать',
		'admin_general_txt_pages_opc02' => 'Скрывать',
		...
		'admin_general_ntf_interval_events' => 'Интервал для проверки новых событий:',
		'admin_general_ntf_msgs' => 'Кол. Уведомления для сообщения:',
		'admin_general_ntf_interval_msgs' => 'Интервал для проверки новых сообщений:',

		'admin_general_ntf_txt' => 'уведомлений (я)',
		'admin_general_ntf_txt_second' => 'секунд',
		...
		'admin_general_chat_txt_seconds' => 'секунды',
		'admin_general_chat_nummsgchat' => 'Количество сообщений, чтобы начать:',
		...
		'admin_general_items_notifications' => 'Лист уведомлений:',
		'admin_general_items_messages' => 'Лист сообщений:',
		'admin_general_items_activities' => 'Активность:',
		'admin_general_items_comments' => 'Комментарии:',
		...
		'admin_manageuser_subtitle2' => 'Редактирование пользователя',
		'admin_manageuser_linkback' => 'Вернутся назад',
		'admin_manageuser_avatar' => 'Аватар',
		'admin_manageuser_firstname' => 'Имя',
		'admin_manageuser_lastname' => 'Фамилия',
		'admin_manageuser_username' => 'Ник пользователя',
		'admin_manageuser_subtitle3' => 'Статус',
		'admin_manageuser_txtuserstatus' => 'Статус пользователя',
		'admin_manageuser_active' => 'Активирован',
		'admin_manageuser_inactive' => 'Заблокирован',
		'admin_manageuser_subtitle4' => 'Группа',
		'admin_manageuser_txtleveluser' => 'Уровень управления',
		'admin_manageuser_isadministrator' => 'Назначить администратором',
		'admin_manageuser_notadministrator' => 'Обычный пользователь',
		'admin_manageuser_subtitle5' => 'Удаление пользователя',
		'admin_manageuser_txtdelete' => 'Хотите удалить данного пользователя?',
		'admin_manageuser_txtalert' => 'Дейстительно хотели бы удалить данного пользователя?',
		'admin_manageuser_bdelete' => 'Удалить',
		'admin_manageuser_txtadministrator' => 'Администратор',
		'admin_manageuser_txtvalidated' => 'Потверждение пользователя',
		...
		'admin_pages_subtitle3' => 'Страница "Правила использования"',
		'admin_pages_subtitle4' => 'Страница "Отказ от ответственности"',
		...
		'admin_censors_alt1' => 'Восстановить',
